...
const menuCards = [
  {
    ...
    title: "EARN",
    links: [
      { label: "Browse Quests", href: "/quests", badge: null },
      { label: "Dashboard", href: "/dashboard", badge: null },
      { label: "Referrals", href: "/dashboard", badge: "NEW" },
    ],
  },
  {
    id: "build",
    title: "BUILD",
    links: [
      { label: "Console", href: "/console", badge: null },
      { label: "Create Campaign", href: "/create", badge: null },
      { label: "Analytics", href: "/console/analytics", badge: null },
    ],
  },
  {
    id: "contact",
      ...
      >
        ...
        >
          <span className="flex flex-col duration-0 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-2/3 group-hover:transition-transform group-hover:duration-300">
            <span className="block leading-[1.25em]">Explore</span>
            <span className="block leading-[1.25em]">Explore</span>
            <span className="block leading-[1.25em]">Explore</span>
          </span>
        </span>
