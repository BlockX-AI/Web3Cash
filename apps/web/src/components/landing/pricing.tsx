...
const plans: Plan[] = [
  {
    name: "Earn",
    tagline: "For quest completers",
    price: "$0",
    period: "forever",
    features: [
      "Unlimited quest completions",
      "USDC payouts on-chain",
      "Referral bonuses",
      "Dashboard & analytics",
    ],
  },
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Start earning for free. Create quests with a project account.
          </p>
        </motion.div>
