...
const testimonials: Testimonial[] = [
  {
    ...
    description:
      "I was skeptical about earning real USDC from simple Twitter tasks. But Web3Cash delivered — every payout landed directly in my wallet. No hoops, no delays.",
    name: "Alex Rivera",
    role: "DeFi Enthusiast",
  },
  {
    title: "Best Growth Tool for Web3",
    description:
      "We ran our first campaign and got 500+ genuine followers in 48 hours. The Sybil protection ensures only real users complete our quests.",
    name: "Sarah Chen",
    role: "Marketing Lead at DeFi Protocol",
  },
  {
    title: "Finally, Transparent Rewards",
    description:
      "Every payout is on-chain and verifiable. No more trusting centralized platforms with your earnings. Web3Cash is how crypto rewards should work.",
    name: "Marcus Johnson",
  ...
  },
  {
    ...
    description:
      "Creating quests takes minutes, and the analytics dashboard gives me real-time insights. The ROI on our campaigns has been incredible.",
    name: "Elena Rodriguez",
    role: "Community Manager",
  },
  {
    title: "My Go-To for Passive Income",
    description:
      "I check Web3Cash every morning for new quests. The referral program is a nice bonus too — I've earned extra USDC just by sharing my link.",
    name: "David Park",
