...
const headlineText = "Earn Real USDC for Web3 Actions";

const cardData = [
  { label: "Twitter Follow", image: "/img/chrome-extension.webp" },
  { label: "Retweet Quest", image: "/img/safari-extension.webp" },
  { label: "Like Quest", image: "/img/api-access.webp" },
  { label: "USDC Rewards", image: "/img/article-summary.webp" },
  { label: "Smart Contracts", image: "/img/video-summary.webp" },
  { label: "On-Chain Payouts", image: "/img/podcast-summary.webp" },
  { label: "Referral Bonus", image: "/img/pdf-summary.webp" },
  { label: "Quest Builder", image: "/img/research-papers.webp" },
  { label: "Sybil Protection", image: "/img/social-threads.webp" },
  { label: "Analytics", image: "/img/email-digest.webp" },
  { label: "Campaign Manager", image: "/img/book-summary.webp" },
];
    ...
    >
      ...
      <div ref={headlineRef} className="relative z-10 mx-auto md:text-center">
        ...
        >
          ...
          via smart contracts. No middlemen.
        </motion.p>
      </div>
