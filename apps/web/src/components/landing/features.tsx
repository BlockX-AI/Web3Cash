...
const features: Feature[] = [
  {
    ...
    description:
      "Follow projects on Twitter, retweet posts, like tweets — Web3Cash handles all quest types with built-in verification.",
  ...
  },
  {
    ...
    description:
      "Get paid in USDC directly to your wallet. No points, no tokens — just real stablecoins via smart contracts.",
  ...
  },
  {
    ...
    title: "Build & grow",
    description:
      "Create campaigns, set budgets, and grow your project. Track analytics and manage quests from your console.",
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
        ...
        >
          <h2 className="mb-4 text-2xl font-medium tracking-tight md:mb-6 md:text-3xl lg:text-4xl">
            Turn Web3 actions into rewards
          </h2>
          <p className="text-muted-foreground mb-6 max-w-sm text-base md:mb-8 md:text-lg">
            Web3Cash helps projects grow and users earn — all powered by
