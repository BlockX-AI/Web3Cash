...
/** Level-2 referral bonus (referrer's referrer). */
...
/** Referral L2 rate in basis points (matches REFERRAL_L2_RATE = 0.03). */
export const REFERRAL_L2_RATE_BPS = Math.round(REFERRAL_L2_RATE * 10_000);
